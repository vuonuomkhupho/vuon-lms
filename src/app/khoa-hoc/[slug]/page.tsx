      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center gap-4">
            <Link href="/khoa-hoc" className="text-sm text-muted-foreground hover:text-foreground transition">Khóa học</Link>
            {session ? (
              <Link href="/dashboard">
      ...
      <main className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="rounded-xl border bg-card p-6 mb-8">
          {!session ? (
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href={`/khoa-hoc/${slug}/1`}>
                <Button size="lg">Vào học</Button>
              </Link>
            </div>
          ) : (
            <div className="flex items-center justify-between">
        ...
        <div className="space-y-2">
          {course.sessions.map((s, idx) => (
            <div
              key={s.id}
              className="flex items-center justify-between rounded-lg border bg-card px-4 py-3 transition hover:bg-accent/50"
            >
